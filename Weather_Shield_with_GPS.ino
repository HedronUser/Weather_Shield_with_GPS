...
static const int RXPin = 0, TXPin = 1; //GPS is attached to pin 4(TX from GPS) and pin 5(RX into GPS)
...
void setup()
{
  ...
  ss.begin(GPSBaud); //Begin listening to GPS over software serial at 9600. This should be the default baud of the module.
